          ...
          <div className="col">
            <div className="containings">
              <div id="slide" className="no-thumbs floor-plans-banners">
                <div className="items exterior-one-slide-one-unit-10  floorplans-thumb">
                ...
                <div className="items exterior-one-slide-one-unit-3d-10 floorplans-thumb">
                  <div className="content">
                    <div className="name">Lorem Ipsum</div>
                    <div className="des">
                      description lorem ipsum sedts at dummy text written here.
