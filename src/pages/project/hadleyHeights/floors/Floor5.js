    ...
    <section className="">
        ...
        <div className="row">
          <div className="col">
            <div className="containings">
              <div id="slide">
                <div className="items exterior-one-slide-floor-five">
      ...
      <div className="left-navigation-menu">
        <div className="row gx-2 m-1">
          {fifthFloors.map((fifthFloors, index) => (
            <div key={index} className="col-6">
              <div
                className={`${
                  fifthFloors.status == true
                    ? "green-bg"
                    : fifthFloors.status == null
                    ? "white-bg"
                    : "red-bg"
                } w-100 px-2`}
              >
                <span className="units-boxes-design m-1 d-flex flex-column align-center justify-content-center py-3">
                  ...
                  <h4 className="bottom-navigation-itemss pt-2 mb-3">
                    {fifthFloors.unitNumber}
                  </h4>
                  <p className="small-text">{fifthFloors.unitType}</p>
                </span>
              </div>
            </div>
          ))}
